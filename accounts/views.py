            ...
            if user.exists():
                ...
                if key:
                    ...
                    if old.exists():
                        ...
                        conn.request("GET", "https://2factor.in/API/R1/?module=SMS_OTP&apikey=e20b3a60-c217-11eb-8089-0200cd936042&to="+phone+"&otpvalue="+str(key)+"&templatename=WomenMark1")
    ...
    def post(self, request, *args, **kwargs):
        ...
        if phone and otp_sent:
            ...
            if old.exists():
                ...
                conn.request("GET", "https://2factor.in/API/V1/e20b3a60-c217-11eb-8089-0200cd936042/SMS/VERIFY/"+otp_session_id+"/"+otp_sent)
                res = conn.getresponse()    
                data = res.read()
                print(data.decode("utf-8"))
                data=data.decode("utf-8")
